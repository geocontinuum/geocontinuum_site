        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-testimonial__comment" => array(
                            "maxWidth" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-testimonial__name" => array(
                            "margin" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => 60,
                    "styles" => array(
                        "@id .dragifywp-testimonial__avatar__wrap" => array(
                            "width" => "{{@model}}px"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-testimonial__job" => array(
                            "fontSize" => "{{@model}}px"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "directives" => [
                        array(
                            ...
                            "attrs" => array(
                                "selector" => "@id .dragifywp-testimonial__comment"
                            )
                        )
                    ]
                )
...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:150px" ng-if="$ctrl.edited.content.length == 0">
    <span class="dragifywp-dnd__emptyItem__label">Testimonial</span>
</div>

<div class="dragifywp-testimonial {{::$ctrl.getID()}}"
     selector=".dragifywp-testimonial__avatar__wrap"
     ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]" id="{{$ctrl.edited.attrs.id}}">
    <div class="dragifywp-carousel owl-carousel" dragifywp-testimonial
        ...
        <div class="dragifywp-testimonial__item" ng-repeat="item in $ctrl.edited.content track by $index">
            <div class="dragifywp-testimonial__avatar__wrap" ng-show="item.attrs.image.url">
                <span class="dragifywp-testimonial__avatar" ng-style="{'background-image':'url(' + item.attrs.image.url + ')'}"></span>
            </div>
            <h6 class="dragifywp-testimonial__name" ng-bind="item.attrs.name"></h6>
            <div class="dragifywp-testimonial__job"><span ng-bind="item.attrs.job"></span></div>
            <p class="dragifywp-testimonial__comment" ng-bind-html="item.content"></p>
        </div>
    </div>
</div>
<?php
...
add_shortcode('dragifywp_testimonial', 'dragifywp_testimonial_callback');
function dragifywp_testimonial_callback($attrs, $content = null) {
    ...
    ob_start(); ?>
    <div class="dragifywp-testimonial <?php echo implode(' ', $classes); ?>"<?php echo $id; ?>>
...
add_shortcode('dragifywp_testimonial_item', 'dragifywp_testimonial_item_callback');
function dragifywp_testimonial_item_callback($attrs, $content = null) {
    $attrs = shortcode_atts(array(
        'class_id' => '',
    ...
    ob_start(); ?>
    <div class="dragifywp-testimonial__item <?php echo $attrs['class_id']; ?>">
        <?php if($background): ?>
            <div class="dragifywp-testimonial__avatar__wrap">
                <span class="dragifywp-testimonial__avatar"<?php echo $background; ?>></span>
            </div>
        <?php endif; ?>
        <h6 class="dragifywp-testimonial__name"><?php echo html_entity_decode($attrs['name']); ?></h6>
        <div class="dragifywp-testimonial__job"><span><?php echo html_entity_decode($attrs['job']); ?></span></div>
        <p class="dragifywp-testimonial__comment"><?php echo do_shortcode($content); ?></p>
    </div>
    <?php
    return ob_get_clean();
}
