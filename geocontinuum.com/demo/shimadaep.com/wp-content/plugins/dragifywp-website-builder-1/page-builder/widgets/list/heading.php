...
<div class="dragifywp-dnd__emptyItem" style="height:60px;" ng-if="!$ctrl.edited.content">
    <span class="dragifywp-dnd__emptyItem__label">Entry Heading</span>
</div>

<dragifywp-tag-wrap ng-class="[$ctrl.edited.attrs.hidden]" prefix="true" id="{{$ctrl.edited.attrs.id}}" tag-class="$ctrl.edited.attrs.class" model="$ctrl.edited" tag-name="$ctrl.edited.attrs.level" selector="{{::$ctrl.getID()}}"></dragifywp-tag-wrap>
<?php
$widget['visual_view'] = ob_get_clean();

$manager->add($widget);

add_shortcode('dragifywp_heading', 'dragifywp_heading_callback');
function dragifywp_heading_callback($attrs, $content = null) {
