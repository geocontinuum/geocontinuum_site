        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-divider__line" => array(
                            "width" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "default_value" => $manager::$colors['border'],
                    "styles" => array(
                        "@id .dragifywp-divider__line--gradient.dragifywp-divider__line--center" => array(
                            "background" => "linear-gradient(to left, rgba(0,0,0,0), {{@model}}, rgba(0,0,0,0))"
                        ),
                        "@id .dragifywp-divider__line--gradient.dragifywp-divider__line--left" => array(
                            "background" => "linear-gradient(to left, rgba(0,0,0,0), {{@model}})"
                        ),
                        "@id .dragifywp-divider__line--gradient.dragifywp-divider__line--right" => array(
...
ob_start();
?>
<div class="dragifywp-divider {{::$ctrl.getID()}}" id="{{$ctrl.edited.attrs.id}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]">
    <div class="dragifywp-divider__line" ng-class="['dragifywp-divider__line--'+$ctrl.edited.attrs.style,'dragifywp-divider__line--'+$ctrl.edited.attrs.align]">
        <span class="dragifywp-divider__text" ng-show="$ctrl.edited.attrs.include == 'text'" dragifywp-editable model="$ctrl.edited" config="{target:'attrs.text', editorType:'1'}" ng-bind-html="$ctrl.edited.attrs.text"></span>
        <span class="dragifywp-divider__goTopBtn" frontend-compile callback="bindGoTop" ng-show="$ctrl.edited.attrs.include == 'goTopBtn'">
            <small><i class="fa fa-angle-up"></i></small>
        </span>
        <span class="dragifywp-divider__icon" ng-show="$ctrl.edited.attrs.include == 'icon'">
...
add_shortcode('dragifywp_divider', 'dragifywp_divider_callback');
function dragifywp_divider_callback($attrs) {
    ...
    ob_start(); ?>
    <div class="dragifywp-divider <?php echo implode(' ', $classes); ?>"<?php echo $id; ?>>
        <div class="dragifywp-divider__line dragifywp-divider__line--<?php echo $attrs['style'] ?> dragifywp-divider__line--<?php echo $attrs['align']; ?>">
            <?php if ($attrs['include'] == 'text') : ?>
                <span class="dragifywp-divider__text"><?php echo html_entity_decode($attrs['text']); ?></span>
            <?php endif; ?>
            <?php if ($attrs['include'] == 'goTopBtn') : ?>
                <span class="dragifywp-divider__goTopBtn">
				<small><i class="fa fa-angle-up"></i></small>
			</span>
            <?php endif; ?>
            <?php if ($attrs['include'] == 'icon') : ?>
                <span class="dragifywp-divider__icon">
