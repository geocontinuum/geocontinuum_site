...
<div class="dragifywp-dnd__emptyItem" style="height:60px;" ng-if="!$ctrl.edited.content">
    <span class="dragifywp-dnd__emptyItem__label">Heading</span>
</div>

<dragifywp-tag-wrap ng-class="[$ctrl.edited.attrs.hidden]" id="{{$ctrl.edited.attrs.id}}" model="$ctrl.edited" tag-text="$ctrl.edited.content" tag-name="$ctrl.edited.attrs.level" selector="{{::$ctrl.getID()}}"></dragifywp-tag-wrap>
<?php
...
add_shortcode('dragifywp_custom_heading', 'dragifywp_custom_heading_callback');
function dragifywp_custom_heading_callback($attrs, $content = null) {
