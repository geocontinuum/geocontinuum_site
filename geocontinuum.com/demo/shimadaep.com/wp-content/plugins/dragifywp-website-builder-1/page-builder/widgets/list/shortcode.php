...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:100px;" ng-if="!$ctrl.edited.content">
...
add_shortcode('dragifywp_shortcode', 'dragifywp_shortcode_callback');
function dragifywp_shortcode_callback($attrs, $content = null) {
