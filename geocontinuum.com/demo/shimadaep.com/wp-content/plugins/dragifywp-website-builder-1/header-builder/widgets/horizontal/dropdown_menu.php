        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        "@id li.dragifywp-menu-current-menu-item > a, @id li:hover > a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => $manager::$colors["primary"],
                    "styles" => array(
                        "@id .menu ul a:hover, @id .menu .dragifywp-menu-current-menu-item > a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
...
<div class="dragifywp-dnd__emptyItem dragifywp-dnd__emptyItem--h" style="width:140px;" ng-if="!$ctrl.edited.attrs.menu_id">
    <span class="dragifywp-dnd__emptyItem__label">Dropdown Menu</span>
</div>

<div class="dragifywp-header__dropdownMenu {{::$ctrl.getID()}}"
     ng-class="[{'dragifywp-header__dropdownMenu--arrow' : $ctrl.edited.attrs.arrow},$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]" dragifywp-onePageMenu model="$ctrl.edited.attrs.one_page">
...
function lhb_h_dropdown_menu_callback($attrs) {
    ...
    if (dragifywp_to_boolean($attrs['arrow'])) {
        $classes[] = 'dragifywp-header__dropdownMenu--arrow';
    }
    ...
    $html = '<div class="dragifywp-header__dropdownMenu ' . implode(' ', $classes) . '">';
