...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem dragifywp-dnd__emptyItem--h" style="width:140px;" ng-if="!$ctrl.model.content">
    <span class="dragifywp-dnd__emptyItem__label">Text</span>
</div>

<div class="dragifywp-header__text {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]"
...
function lhb_h_text_callback($attrs, $content = null) {
    ...
    $html = '<div class="dragifywp-header__text ' . implode(' ', $classes) . '">' . do_shortcode($content) . '</div>';
