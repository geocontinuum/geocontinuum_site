...
<div class="dragifywp-aside__megaMenu {{::$ctrl.getID()}}"
     ng-class="[{'dragifywp-aside__megaMenu--title' : $ctrl.edited.attrs.title_show},$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]">
...
function lhb_v_mega_menu_callback($attrs) {
    ...
    if(dragifywp_to_boolean($attrs['title_show'])){
        $classes[] = 'dragifywp-aside__megaMenu--title';
    }
    ...
    $html = '<div class="dragifywp-aside__megaMenu ' . implode(' ', $classes) . '">';
