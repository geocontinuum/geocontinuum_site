        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 700,
                    "styles" => array(
                        "@id,@id .dragifywp-menu-column-title" => array(
                            "fontWeight" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "default_value" => 0,
                    "styles" => array(
                        "@id a, @id .dragifywp-menu-column-title span" => array(
                            "margin" => "0 {{@model}}px"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        "@id .menu > li.dragifywp-menu-current-menu-item > a,@id .menu > li:hover > a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => 40,
                    "styles" => array(
                        "@id .menu .dragifywp-menu-submenu a, @id .menu .dragifywp-menu-column-title" => array(
                            "height" => "{{@model}}px",
                            "lineHeight" => "{{@model}}px"
                        )
                    )
                ...
                array(
                    ...
                    "default_value" => $manager::$colors["primary"],
                    "styles" => array(
                        "@id .menu .dragifywp-menu-column-title:hover, @id .menu .dragifywp-menu-submenu a:hover, @id .menu .dragifywp-menu-submenu li.dragifywp-menu-current-menu-item a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem dragifywp-dnd__emptyItem--v" style="height:80px;" ng-if="!$ctrl.edited.attrs.menu_id">
    <span class="dragifywp-dnd__emptyItem__label">Toggle Menu</span>
</div>

<div class="dragifywp-aside__toggleMenu {{::$ctrl.getID()}}"
...
function lhb_v_toggle_menu_callback($attrs) {
    ...
    $html = '<div class="dragifywp-aside__toggleMenu ' . implode(' ', $classes) . '">';
    $html .=dragifywp_get_menu_content($attrs['menu_id'], 'toggle');
    $html .= '</div>';
