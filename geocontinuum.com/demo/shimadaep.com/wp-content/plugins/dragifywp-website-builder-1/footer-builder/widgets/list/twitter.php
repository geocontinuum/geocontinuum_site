...
ob_start();
?>
<div class="dragifywp-twitter {{::$ctrl.getID()}}"
...
function lfb_twitter_callback($attrs) {
    ...
    $html = '<div class="dragifywp-twitter ' . implode(' ', $classes) . '"' . ' data-num="' . $attrs['num'] . '">';
    $html .= '<div class="dragifywp-contentLoader"><span></span><span></span><span></span></div>';
    $html .= '</div>';
