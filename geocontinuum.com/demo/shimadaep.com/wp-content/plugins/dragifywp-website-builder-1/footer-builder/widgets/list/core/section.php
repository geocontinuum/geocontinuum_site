                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "styles" => array(
                                "@id.dragifywp-section--bgStyle-image" => array(
...
<div class="dragifywp-section {{::$ctrl.getID()}}"
     ng-class="[$ctrl.section.attrs.half_bg, $ctrl.section.attrs.class, $ctrl.section.attrs.hidden,'dragifywp-section--bgStyle-'+$ctrl.section.attrs.bg_style,'dragifywp-section--bgEffect-'+$ctrl.section.attrs.bg_effect, 'dragifywp-section--align-'+$ctrl.section.attrs.content_align]">
...
function lfb_section_callback($attrs, $content = '') {
    ...
    if ($attrs['bg_effect'] != 'none') {
        $classes[] = 'dragifywp-section--bgEffect-' . $attrs['bg_effect'];
    }
    ...
    ob_start(); ?>
    <div class="dragifywp-section dragifywp-footer__section <?php echo implode(' ', $classes); ?>">
