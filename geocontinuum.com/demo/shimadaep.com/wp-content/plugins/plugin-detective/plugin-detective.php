<?php
/**
 * Plugin Name: Plugin Detective
 * Plugin URI:  https://nsqua.red
 * Description: Quickly identify & fix plugin conflicts
 * Version:     1.0.13
 * Author:      N Squared
...
final class Plugin_Detective {
	...
	public function meets_requirements() {
		...
		if ( defined( 'MULTISITE' ) && !empty( MULTISITE ) || ( function_exists( 'is_multsite' ) && is_multsite() ) ) {
