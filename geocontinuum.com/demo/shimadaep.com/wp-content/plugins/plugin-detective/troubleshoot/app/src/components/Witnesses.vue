<template>
  <div class="witnesses">
    <loading text="Sorting out the suspects..." v-if="loading"></loading>
    <template v-else>
      <md-toolbar md-elevation="0" class="md-primary">
        <h1 class="md-title">Key Witnesses (Required Plugins)</h1>
      </md-toolbar>
      <md-content>
        <p class="md-body-2">Which plugins are required for the site's functionality?</p>
      </md-content>
      <md-list>
      ...
      <div class="corner-otto">
        <bubble>
          <p>Which plugins are required in order for the site to work correctly?</p>
