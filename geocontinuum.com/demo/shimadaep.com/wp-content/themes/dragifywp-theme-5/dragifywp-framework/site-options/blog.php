                    ...
                    "content" => [
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-heroSlider,.dragifywp-heroSlider .owl-item" => array(
                                    "height" => "{{@model}}"
                                )
                            )
                        ),
                        array(
                            ...
                            "styles" => array(
                                ".dragifywp-heroSlider__overlay,.dragifywp-heroSlider" => array(
                        ...
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-heroSlider__content" => array(
                                    "margin" => "{{@model}}"
                                )
                            )
                        )
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "styles" => array(
                                ".dragifywp-heroSlider .owl-dot" => array(
                                    "backgroundColor" => "{{@model}}"
                                )
                            )
                        ),
                        array(
                            ...
                            "styles" => array(
                                ".dragifywp-heroSlider .owl-dot.active" => array(
                                    "backgroundColor" => "{{@model}}"
                                )
                            )
                        )
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-heroSlider__title" => array(
                                    "fontSize" => "{{@model}}px"
                                )
                            )
                        ),
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "styles" => array(
                                ".dragifywp-heroSlider__link" => array(
                                    "backgroundColor" => "{{@model}}"
                                )
                            )
                        ),
                        ...
                        array(
                            ...
                            "default_value" => $manager::$colors["primary"],
                            "styles" => array(
                                ".dragifywp-heroSlider__link:hover" => array(
                                    "backgroundColor" => "{{@model}}"
                                )
                            )
                        ),
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "styles" => array(
                                ".dragifywp-heroSlider__desc" => array(
                                    "color" => "{{@model}}"
                                )
                            )
                        ),
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "default_value" => $manager::$colors["overlay_primary"],
                            "styles" => array(
                                ".dragifywp-heroSlider__author a" => array(
                                    "color" => "{{@model}}"
                                )
                            )
                        )
...
$manager::addChildPanel("blog_header", "blog", array(
    "name" => "Header",
    "direct_links" => array(
        ".dragifywp-blogHeader__label" => array(
            "position" => array(
                "left" => "50%",
                "top" => "2px"
            ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "attrs" => array(
                        ...
                        "config" => array(
                            ...
                            "class" => "column",
                            "watch" => "attr",
                            "selector" => ".dragifywp-blog.dragifywp-blogClassicGrid",
                            "attr" => "data-column"
                        )
                    ),
                    "default_value" => "4"
                ...
                array(
                    ...
                    "default_value" => 15,
                    "styles" => array(
                        ".dragifywp-bcgi" => array(
                            "padding" => "0 {{@model}}px"
                        ),
                        ".dragifywp-blogClassicGrid__wrap" => array(
                            "margin" => "0 -{{@model}}px"
                        ),
                        ".dragifywp-blogClassicGrid" => array(
                            "margin" => "0 -{{@model}}px",
                            "padding" => "0 {{@model}}px"
                        )
                    )
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-blogMetro [class*='dragifywp-metro--s'] > *" => array(
                            "paddingBottom" => "{{@model}}%"
                        ),
                        ".dragifywp-blogMetro [class*='dragifywp-metro--v'] > *" => array(
                            "paddingBottom" => "{{@model*2}}%"
                        ),
                        ".dragifywp-blogMetro [class*='dragifywp-metro--h'] > *" => array(
                            "paddingBottom" => "{{@model/2}}%"
                        )
                    )
                ),
...
$manager::addChildPanel("blog_paging", "blog", array(
    "name" => "Paging",
    "direct_links" => array(
        ".dragifywp-blogPagination" => array(
            "position" => array(
                "left" => "0px",
                "top" => "0px"
            ),
