        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 500,
                    "styles" => array(
                        ".dragifywp--mBold,[type='submit'],dt,th" => array(
                            "fontWeight" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "directives" => [
                        array(
                            "tag" => "preview-general-font-embed",
                            "attrs" => array(
                                "selector" => "h1,h2,h3,h4,h5,h6,.dragifywp-h"
                            )
                        )
                    ]
                ),
                array(
                    ...
                    "default_value" => 1.3,
                    "styles" => array(
                        "h1,h2,h3,h4,h5,h6,.dragifywp-h" => array(
                            "lineHeight" => "{{@model}}em"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "directives" => [
                        array(
                            "tag" => "preview-general-font-embed",
                            "attrs" => array(
                                "selector" => ".dragifywp-serif, .dragifywp-pSerif p, .dragifywp-iSerif i:not([class]), .dragifywp-hSerif h1, .dragifywp-hSerif h2, .dragifywp-hSerif h3, .dragifywp-hSerif h4, .dragifywp-hSerif h5, .dragifywp-hSerif h6"
                            )
                        )
                    ]
                ),
...
foreach($headings as $heading){
    $type = $heading["type"];
    $selector = '.dragifywp-entry h'.$type.':not([class]),.dragifywp-h'.$type;
            ...
            "content" => [
                array(
                    ...
                    "attrs" => array(
                        "label" => "Kit Manager",
                        "type" => "typekit",
                        "desc" => "This Panel contains options for integrating TYPEKIT Fonts into the site. For the detailed guidance, please go through <a href='http://docs.dragify.com/dragifywp/v1/guide/site-options/typekit.html' target='_blank'>the Instruction</a>."
                    )
                )
            ]
        )
