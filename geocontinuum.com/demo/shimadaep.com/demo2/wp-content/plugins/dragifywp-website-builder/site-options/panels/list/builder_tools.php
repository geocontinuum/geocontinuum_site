            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-container, .dragifywp-container__wrap" => array(
                            "maxWidth" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "directives" => [
                        array(
                            ...
                            "attrs" => array(
                                "selector" => ".dragifywp-container, .dragifywp-container__wrap",
                                "property" => "max-width"
                            )
                        )
                    ]
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => 15,
                    "styles" => array(
                        ".dragifywp-container,.dragifywp-container__column,.dragifywp-column,.dragifywp-page__column" => array(
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => 3,
                    "styles" => array(
                        ".dragifywp-section__bg--parallax .dragifywp-section__bg__image" => array(
                            "top" => "-{{@model*200/3}}px",
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-videoPopup,.pswp__bg" => array(
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-videoPopup__loading" => array(
                            "borderLeftColor" => "{{@model}}",
                            "borderTopColor" => "{{@model}}"
                        ),
                        ".dragifywp-videoPopup__close:before,.dragifywp-videoPopup__close:after,.pswp__button--close:after,.pswp__button--close:before" => array(
                            "backgroundColor" => "{{@model}}"
                        ),
