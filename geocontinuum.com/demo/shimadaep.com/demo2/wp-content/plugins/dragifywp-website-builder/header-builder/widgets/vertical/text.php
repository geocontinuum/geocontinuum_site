...
<div class="dragifywp-aside__text {{::$ctrl.getID()}}"  ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]" ng-bind-html="$ctrl.edited.content | trustashtml"></div>
<?php
...
function lhb_v_text_callback($attrs, $content = null) {
    ...
    $html = '<div class="dragifywp-aside__text '.implode(' ', $classes).'">'.$content.'</div>';
