        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-header__container" => array(
                            "maxWidth" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "responsive_styles" => array(
                                "@id .dragifywp-header__container--styled" => array(
                                    "padding" => "{{@model}}"
                                )
                            )
                        ),
...
ob_start();
?>
<div class="dragifywp-header__section {{::$ctrl.getID()}}"
    ...
    <div class="dragifywp-container" ng-class="{'dragifywp-container--fullwidth' : $ctrl.section.attrs.fullwidth}">
        <div class="dragifywp-row">
            <div class="dragifywp-header__container" ng-class="{'dragifywp-header__container--styled' : $ctrl.section.attrs.container_style}">
                <horizontal-column-list section="$ctrl.section" on-update="$ctrl.update(col,p,v)"></horizontal-column-list>
            </div>
        </div>
    </div>
    <button ng-show="$ctrl.section.attrs.close_btn" class="dragifywp-header__section__closeBtn"><i ng-class="$ctrl.section.attrs.close_icon"></i></button>
    <div class="dragifywp-dnd__visual dragifywp-dnd__visual--lv2 lvh__{{::$ctrl.getID()}}"
         ...
         dragifywp-detect-hover-node-horizontal="$ctrl.section">
        <span class="dragifywp-dnd__visual__name">Section</span>
    </div>
</div>
<?php
...
function lhb_h_section_callback($attrs, $content = null) {
    ...
    $html = '<div class="dragifywp-header__section ' . implode(' ', $classes) . '">';
    $html .= '<div class="dragifywp-container'.(dragifywp_to_boolean($attrs['fullwidth']) ? ' dragifywp-container--fullwidth' : '').'">';
    $html .= '<div class="dragifywp-row">';
    $html .= '<div class="dragifywp-header__container'.(dragifywp_to_boolean($attrs['container_style']) ? ' dragifywp-header__container--styled': '').'">';
