        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 10,
                    "styles" => array(
                        "@id .dragifywp-widget__media-item" => array(
                            "padding" => "{{@model}}px 0"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "default_value" => 36,
                    "styles" => array(
                        "@id .dragifywp-widget__media__avatar" => array(
                            "width" => "{{@model}}px",
                            "height" => "{{@model}}px"
                        )
                    )
                ...
                array(
                    ...
                    "styles" => array(
                        "@id .dragifywp-widget__twitter__user" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "styles" => array(
                        "@id .dragifywp-widget__twitter__content" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "default_value" => $manager::$colors["primary"],
                    "styles" => array(
                        "@id .dragifywp-widget__twitter__content a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "styles" => array(
                        "@id .dragifywp-widget__twitter__time" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
...
ob_start();
?>
<div class="dragifywp-aside__twitter {{::$ctrl.getID()}}"
     ng-class="[$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]"
     dragifywp-twitter number-items="$ctrl.edited.attrs.num"></div>
<?php
...
function lhb_v_twitter_callback($attrs) {
    ...
    $html = '<div class="dragifywp-twitter" data-num="' . $attrs['num'] . '">';
    $html .= '<ul class="dragifywp-aside__twitter ' . implode(' ', $classes) . '"><div class="dragifywp-contentLoader"><span></span><span></span><span></span></div></ul>';
    $html .= '</div>';
