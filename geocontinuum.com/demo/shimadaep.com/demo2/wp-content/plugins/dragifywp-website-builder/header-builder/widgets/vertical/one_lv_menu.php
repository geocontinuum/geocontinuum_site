...
<div class="dragifywp-aside__oneLvMenu {{::$ctrl.getID()}}"
     ng-class="[{'dragifywp-aside__oneLvMenu--noEdge':$ctrl.edited.attrs.no_edge},$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]">
...
function lhb_v_one_level_menu_callback($attrs) {
    ...
    if (dragifywp_to_boolean($attrs['no_edge'])) {
        $classes[] = 'dragifywp-aside__oneLvMenu--noEdge';
    }
    ...
    $html = '<div class="dragifywp-aside__oneLvMenu ' . implode(' ', $classes) . '">';
