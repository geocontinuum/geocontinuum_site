...
ob_start();
?>
<div class="dragifywp-stars {{::$ctrl.getID()}}" id="{{$ctrl.edited.attrs.id}}"
...
add_shortcode('dragifywp_stars', 'dragifywp_stars_callback');
function dragifywp_stars_callback($attrs, $content) {
    ...
    ob_start(); ?>
    <div class="dragifywp-stars <?php echo implode(' ', $classes); ?>"<?php echo $id.$animation; ?>>
        <?php echo $starTag; ?>
    </div>
    <?php
    return ob_get_clean();
