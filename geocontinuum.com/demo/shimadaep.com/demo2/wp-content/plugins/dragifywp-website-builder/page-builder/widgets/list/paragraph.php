...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:70px;" ng-if="!$ctrl.edited.content">
    <span class="dragifywp-dnd__emptyItem__label">Paragraph</span>
</div>

<p class="{{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]" id="{{$ctrl.edited.attrs.id}}" model="$ctrl.edited" dragifywp-editable config="{target:'content', editorType:'0'}" ng-bind-html="$ctrl.edited.content | trustashtml"></p>
<?php
$widget['visual_view'] = ob_get_clean();

$manager->add($widget);

add_shortcode('dragifywp_paragraph', 'dragifywp_paragraph_callback');
function dragifywp_paragraph_callback($attrs, $content = null) {
