...
ob_start();
?>
<div class="dragifywp-gmap {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]" id="{{$ctrl.edited.attrs.id}}">
    <div class="dragifywp-gmap__container" dragifywp-google-map map-zoom="$ctrl.edited.attrs.zoom"
...
add_shortcode('dragifywp_map', 'dragifywp_map_callback');
function dragifywp_map_callback($attrs, $content = null) {
    ...
    ob_start(); ?>
    <div class="dragifywp-gmap <?php echo implode(' ', $classes); ?>" id="<?php echo $attrs['id'] ?>">
        <div class="dragifywp-gmap__container"
...
add_shortcode('dragifywp_marker', 'dragifywp_marker_callback');
function dragifywp_marker_callback($attrs) {
    $attrs = shortcode_atts(array(
        'class_id' => '',
        'center' => 'true',
        'lat' => '59.327',
    ...
    ob_start(); ?>
    <div class="dragifywp-marker <?php echo $attrs['class_id']; ?>"
