...
<div class="dragifywp-dnd__emptyItem" style="height:70px;" ng-if="!$ctrl.edited.content">
    <span class="dragifywp-dnd__emptyItem__label">Text</span>
</div>

<div ng-class="[$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]" id="{{$ctrl.edited.attrs.id}}" model="$ctrl.edited" dragifywp-editable config="{target:'content', editorType:'4'}" ng-bind-html="$ctrl.edited.content | trustashtml"></div>
<?php
$widget['visual_view'] = ob_get_clean();

$manager->add($widget);

add_shortcode('dragifywp_text', 'dragifywp_text_callback');
function dragifywp_text_callback($attrs, $content = null) {
