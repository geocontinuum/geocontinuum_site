...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:100px;" ng-if="!$ctrl.edited.attrs.iframe">
    <span class="dragifywp-dnd__emptyItem__label">Play Button</span>
</div>

<button class="dragifywp-playButton dragifywp-videoPopup__launch {{::$ctrl.getID()}}" frontend-compile callback="bindVideoPopup" ng-class="[$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]" id="{{$ctrl.edited.attrs.id}}" data-iframe="{{$ctrl.edited.attrs.iframe}}">
    <i class="dragifywp-playButton__icon fa fa-play"></i>
</button>
<?php
...
add_shortcode('dragifywp_play_button', 'dragifywp_play_button_callback');
function dragifywp_play_button_callback($attrs) {
    ...
    ob_start(); ?>
    <button class="dragifywp-playButton dragifywp-videoPopup__launch <?php echo implode(' ', $classes) ?>"<?php echo $id.$animation; ?> data-iframe="<?php echo $attrs['iframe']; ?>">
        <i class="dragifywp-playButton__icon fa fa-play"></i>
    </button>
    <?php
    return ob_get_clean();
