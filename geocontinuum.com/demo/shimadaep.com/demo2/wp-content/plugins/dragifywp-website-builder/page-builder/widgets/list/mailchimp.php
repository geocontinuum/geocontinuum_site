...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:60px;" ng-if="!$ctrl.model.content">
    <span class="dragifywp-dnd__emptyItem__label">Mailchimp</span>
</div>

<div class="dragifywp-mailchimp {{::$ctrl.getID()}}" ng-class="['dragifywp-mailchimp--' + $ctrl.edited.attrs.style, {'dragifywp-mailchimp--slimOnMobile': ($ctrl.edited.attrs.style == 'hoz' && $ctrl.edited.attrs.slim_on_mobile)} ,$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]" id="{{$ctrl.edited.attrs.id}}" ng-bind-html="$ctrl.model.content | trustashtml"></div>
...
add_shortcode('dragifywp_mailchimp', 'dragifywp_mailchimp_callback');
function dragifywp_mailchimp_callback($attrs, $content) {
    ...
    $classes[] = 'dragifywp-mailchimp--'.$attrs['style'];
    if($attrs['style'] == 'hoz' && dragifywp_to_boolean($attrs['slim_on_mobile'])){
        $classes[] = 'dragifywp-mailchimp--slimOnMobile';
    }
    ...
    <?php endif; ?>
    <div class="dragifywp-mailchimp <?php echo implode(' ', $classes); ?>"<?php echo $id; ?>>
        <?php echo $content; ?>
    </div>
    <?php
    return ob_get_clean();
