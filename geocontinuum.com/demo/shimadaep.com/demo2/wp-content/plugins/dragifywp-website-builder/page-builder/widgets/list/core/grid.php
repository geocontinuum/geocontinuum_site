...
add_shortcode('dragifywp_grid', 'dragifywp_grid_callback');
function dragifywp_grid_callback($attrs, $content) {
...
add_shortcode('dragifywp_grid_column', 'dragifywp_grid_column_callback');
function dragifywp_grid_column_callback($attrs, $content) {
    $attrs = shortcode_atts(array(
        'width' => '1-2',
    ), $attrs, DragifyWPPageBuilderClient::DRAGIFYWP_SHORTCODE_ATTS_FILTER);
