...
$manager::addPanel("search_page",array(
    ...
    "name" => "Search Page",
    "direct_links" => array(
        ".dragifywp-search__header" => array(
            "position" => array(
                "bottom" => "30px",
                "right" => "40px"
            ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-search__bg__image" => array(
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-search__overlay" => array(
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-search__container" => array(
                            "maxWidth" => "{{@model}}"
                        )
                    )
                ),
