        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => $manager::$colors["heading"],
                    "styles" => array(
                        "blockquote:not([class]),.dragifywp-entry blockquote p" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        "blockquote:not([class]),.dragifywp-entry blockquote:not([class]) p" => array(
                            "fontSize" => "{{@model}}px"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "directives" => [
                        array(
                            ...
                            "attrs" => array(
                                "selector" => "blockquote:not([class]),.dragifywp-entry blockquote:not([class]) p"
                            )
                        )
                    ]
                )
