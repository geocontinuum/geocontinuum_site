...
$manager::addChildPanel("single_post_hero", "single_post", array(
    "name" => "Hero Section",
    "direct_links" => array(
        ".dragifywp-singlePost__info" => array(
            "position" => array(
                "top" => 0,
                "left" => 0
            ),
        ...
        ".dragifywp-singlePost__media" => array(
            "position" => array(
                "top" => 0,
                "left" => 0
            ),
        ...
        ".dragifywp-singlePost__title" => array(
            "position" => array(
                "top" => "2px",
                "left" => "2px"
            ),
        ...
        ".dragifywp-singlePost__hero__title" => array(
            "position" => array(
                "top" => "5px",
                "left" => "5px"
            ),
        ...
        ".dragifywp-singlePost__hero" => array(
            "position" => array(
                "top" => "20px",
                "right" => "20px"
            ),
        ...
        ".dragifywp-singlePost__hero__content__wrap" => array(
            "position" => array(
                "top" => "0px",
                "left" => "50%"
            ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-singlePost__hero__overlay" => array(
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-singlePost__hero__cats a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "default_value" => $manager::$colors["overlay_primary"],
                    "styles" => array(
                        ".dragifywp-singlePost__hero__author a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
...
$manager::addChildPanel("single_post_layout", "single_post", array(
    "name" => "Layout",
    "direct_links" => array(
        ".dragifywp-singlePost__footer" => array(
            "position" => array(
                "right" => "10px",
                "top" => "10px"
            ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-singlePost .dragifywp-container,.dragifywp-postComment.dragifywp-container" => array(
                            "maxWidth" => "{{@model}}"
                        )
                    )
                )
...
$manager::addChildPanel("single_post_tags", "single_post", array(
    "name" => "Tags",
    "direct_links" => array(
        ".dragifywp-singlePost__tags" => array(
            "position" => array(
                "top" => "2px",
                "left" => "2px"
            ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-singlePost__tag" => array(
                            "backgroundColor" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-singlePost__tag:hover" => array(
                            "backgroundColor" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-singlePost__share " => array(
                                    "margin" => "{{@model}}"
                                )
                            )
                        ),
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-singlePost__share svg" => array(
                                    "width" => "{{@model}}px",
                                    "height" => "{{@model}}px"
                                )
                            )
                        ...
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-singlePost__share a" => array(
                                    "marginLeft" => "{{@model}}px"
                                )
                            )
                        ),
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "responsive_styles" => array(
                                ".dragifywp-postComment__wrap" => array(
                                    "padding" => "{{@model}}"
                                )
                            )
                        ),
