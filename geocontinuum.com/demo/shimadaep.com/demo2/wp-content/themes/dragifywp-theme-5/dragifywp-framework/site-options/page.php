...
$manager::addChildPanel("page_layout", "page", array(
    "name" => "Spacing",
    "direct_links" => array(
        ".dragifywp-page__sidebar > div" => array(
            "position" => array(
                "right" => "0px",
                "top" => "0px"
            ),
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-page__content,.dragifywp-page__sidebar" => array(
                            "paddingBottom" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "attrs" => array(
                        ...
                        "type" => "toggle-class",
                        "config" => array(
                            "class" => "dragifywp-page--hasBorder",
                            "selector" => ".dragifywp-page--hasSidebar"
                        )
                    ),
                    "default_value" => false
                )
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 40,
                    "styles" => array(
                        ".dragifywp-page__content--paddingRight" => array(
                            "paddingRight" => "{{@model}}px"
                        ),
                        ".dragifywp-page__content--paddingLeft" => array(
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => "25%",
                    "styles" => array(
                        ".dragifywp-page--singleSidebar .dragifywp-page__sidebar" => array(
                            "width" => "{{@model}}"
                        ),
                        ".dragifywp-page--singleSidebar .dragifywp-page__content" => array(
                ...
                array(
                    ...
                    "default_value" => 0,
                    "styles" => array(
                        ".dragifywp-page__sidebar--paddingRight" => array(
                            "paddingRight" => "{{@model}}px"
                        ),
                        ".dragifywp-page__sidebar--paddingLeft" => array(
                            "paddingLeft" => "{{@model}}px"
                        )
                    )
                )
...
$manager::addChildPanel("page_hero_section", "page", array(
    ...
    "direct_links" => array(
        ...
        ".dragifywp-page__hero__title" => array(
            "position" => array(
                "right" => "0px",
                "top" => "0px"
            ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-page__hero__content" => array(
                            "textAlign" => "{{@model}}"
                        )
                    )
                )
...
$manager::addChildPanel("page_breadcrumb", "page", array(
    ...
    "direct_links" => array(
        ...
        ".dragifywp-breadcrumb__title" => array(
            "position" => array(
                "top" => "0px",
                "right" => "0px"
            ),
        ...
        ".dragifywp-breadcrumb__link li:last-child" => array(
            "position" => array(
                "bottom" => "0px",
                "right" => "0px"
            ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-breadcrumb__link a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-breadcrumb__link a:hover" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-breadcrumb__link" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
