...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:100px" ng-if="$ctrl.edited.attrs.menu_id == 0">
    <span class="dragifywp-dnd__emptyItem__label">Menu</span>
</div>

<div class="dragifywp-menu {{::$ctrl.getID()}}"
...
function lfb_menu_callback($attrs) {
    ...
    ob_start(); ?>
    <div class="dragifywp-menu <?php echo implode(' ', $classes); ?>">
        <?php echo dragifywp_get_menu_content($attrs['menu_id'], '', 1); ?>
    </div>
    <?php
    return ob_get_clean();
}