        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => 100,
                    "styles" => array(
                        "@id .dragifywp-aside__divider__line" => array(
                            "width" => "{{@model}}%"
                        )
                    )
                ),
...
ob_start();
?>
<div class="dragifywp-aside__divider {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]">
    <div class="dragifywp-aside__divider__line"></div>
</div>
<?php
...
function lhb_v_divider_callback($attrs) {
    ...
    $html = '<div class="dragifywp-aside__divider ' . implode(' ', $classes) . '"><div class="dragifywp-aside__divider__line"></div></div>';
