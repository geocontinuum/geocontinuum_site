                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "responsive_styles" => array(
                                "@id-menu .dragifywp-header__fullscreenMenu__close" => array(
                                    "width" => "{{@model}}px",
                                    "height" => "{{@model}}px"
                                ),
                                "@id-menu .dragifywp-header__fullscreenMenu__close:before" => array(
                                    "height" => "{{@model}}px"
                                ),
                                "@id-menu .dragifywp-header__fullscreenMenu__close:after" => array(
                                    "width" => "{{@model}}px"
                                )
                            )
                        ),
                        ...
                        array(
                            ...
                            "default_value" => "#ffffff",
                            "styles" => array(
                                "@id-menu .dragifywp-header__fullscreenMenu__close:before,@id-menu .dragifywp-header__fullscreenMenu__close:after" => array(
                                    "background" => "{{@model}}"
                                )
                            )
                        )
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 22,
                    "styles" => array(
                        "@id .dragifywp-header__burgerBtn__icon" => array(
                            "width" => "{{@model}}px"
                        )
                    )
                ),
...
ob_start();
?>
<div class="dragifywp-header__burgerBtn {{::$ctrl.getID()}}"
...
function lhb_h_fullscreen_menu_callback($attrs) {
    ...
    $menu =dragifywp_get_menu_content($attrs['menu_id'], '', 1);

    $html = '<div class="dragifywp-header__burgerBtn dragifywp-header__burgerBtn_fsMenu ' . implode(' ', $classes) . '" id="'.$attrs['class_id'].'">';
