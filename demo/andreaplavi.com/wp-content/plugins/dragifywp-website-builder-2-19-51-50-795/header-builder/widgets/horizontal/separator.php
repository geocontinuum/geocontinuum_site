...
ob_start();
?>
    <div class="dragifywp-header__separator {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class]"></div>
<?php
...
function lhb_h_separator_callback($attrs, $content = null) {
    ...
    $html = '<div class="dragifywp-header__separator ' . implode(' ', $classes).'"></div>';
