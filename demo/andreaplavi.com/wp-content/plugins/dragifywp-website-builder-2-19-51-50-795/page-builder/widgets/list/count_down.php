            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-countDown__col" => array(
                            "width" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-countDown__num" => array(
                            "width" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "directives" => [
                        array(
                            ...
                            "attrs" => array(
                                "selector" => "@id .dragifywp-countDown__num"
                            )
                        )
                    ]
                ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-countDown__desc" => array(
                            "fontSize" => "{{@model}}px"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "directives" => [
                        array(
                            "tag" => "embed-font-source",
                            "attrs" => array(
                                "selector" => "@id .dragifywp-countDown__desc"
                            )
                        )
                    ]
                )
...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:60px;" ng-if="!$ctrl.edited.attrs.time">
    <span class="dragifywp-dnd__emptyItem__label">COUNT DOWN</span>
</div>

<div frontend-compile model="$ctrl.edited" callback="bindCountDown" attrs="['desc', 'time']" destroy-callback="onCountDownDestroy" class="dragifywp-countDown {{::$ctrl.getID()}}"
     ng-class="[$ctrl.edited.attrs.hidden, $ctrl.edited.attrs.class, {'dragifywp-countDown--inline':$ctrl.edited.attrs.inline}]"
...
add_shortcode('dragifywp_count_down', 'dragifywp_count_down_callback');
function dragifywp_count_down_callback($attrs, $content) {
    ...
    if(dragifywp_to_boolean($attrs['inline'])){
        $classes[] = 'dragifywp-countDown--inline';
    }
    ...
    ob_start(); ?>
    <div class="dragifywp-countDown <?php echo implode(' ', $classes); ?>" data-settings="<?php echo esc_attr(json_encode($settings)); ?>"<?php echo $id; ?>>
        <div class="dragifywp-countDown__col">
            <span class="dragifywp-countDown__num"><?php echo $days; ?></span>
            <span class="dragifywp-countDown__desc"><?php echo $tokens[0]; ?></span>
        </div>
        <div class="dragifywp-countDown__col">
            <span class="dragifywp-countDown__num"><?php echo $hours; ?></span>
            <span class="dragifywp-countDown__desc"><?php echo $tokens[1]; ?></span>
        </div>
        <div class="dragifywp-countDown__col">
            <span class="dragifywp-countDown__num"><?php echo $minutes; ?></span>
            <span class="dragifywp-countDown__desc"><?php echo $tokens[2]; ?></span>
        </div>
        <div class="dragifywp-countDown__col">
            <span class="dragifywp-countDown__num"><?php echo $seconds; ?></span>
            <span class="dragifywp-countDown__desc"><?php echo $tokens[3]; ?></span>
        </div>
    </div>
    <?php
    return ob_get_clean();
