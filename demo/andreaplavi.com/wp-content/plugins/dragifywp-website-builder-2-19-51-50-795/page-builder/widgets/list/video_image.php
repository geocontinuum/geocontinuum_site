            ...
            "content" => [
                ...
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-videoImage__image" => array(
                            "width" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "styles" => array(
                        "@id img,@id .dragifywp-videoImage__image" => array(
                            "borderRadius" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "default_value" => "",
                    "styles" => array(
                        "@id .dragifywp-videoImage__image:before" => array(
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "default_value" => 1,
                    "styles" => array(
                        "@id .dragifywp-videoImage__image:hover" => array(
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        "@id .dragifywp-videoImage__playBtn" => array(
                            "width" => "{{@model}}px",
                            "height" => "{{@model}}px"
                        )
                    )
...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem" style="height:160px;" ng-if="!$ctrl.edited.attrs.image.url">
    <span class="dragifywp-dnd__emptyItem__label">Video Image</span>
</div>

<div class="dragifywp-videoImage {{::$ctrl.getID()}}"
     ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]" id="{{$ctrl.edited.attrs.id}}">
    <div class="dragifywp-videoImage__image dragifywp-videoPopup__launch" frontend-compile callback="bindVideoPopup" data-iframe="{{$ctrl.edited.attrs.iframe}}">
        <img ng-src="{{$ctrl.edited.attrs.image.url}}"/>bord
        <span class="dragifywp-videoImage__playBtn"><i class="fa fa-play" aria-hidden="true"></i></span>
    </div>
</div>
<?php
...
add_shortcode('dragifywp_video_image', 'dragifywp_video_image_callback');
function dragifywp_video_image_callback($attrs) {
    ...
    ob_start(); ?>
    <div class="dragifywp-videoImage <?php echo implode(' ', $classes) ?>"<?php echo $id.$animation; ?>>
        <div class="dragifywp-videoImage__image dragifywp-videoPopup__launch" data-iframe="<?php echo $attrs['iframe']; ?>">
