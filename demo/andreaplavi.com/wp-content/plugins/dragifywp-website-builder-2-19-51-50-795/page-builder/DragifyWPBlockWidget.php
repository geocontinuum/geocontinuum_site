...
class DragifyWPBlockWidget extends WP_Widget {

	public function __construct() {
		parent::__construct('dragifywp_block_widget', 'DragifyWP Block');
	}
	...
	public function widget($args, $instance) {
		...
		echo do_shortcode('[dragifywp_block id="' . $instance['id'] . '"]');
	}
	...
	public function form($instance) {
		...
		<p>
			...
			<script type="text/javascript">
				function generate_edit_link(element) {
					...
					var edit_block = jQuery(element).parent().parent().find('.dragifywp-edit-block');
		...
		?>
		<p class="dragifywp-edit-block"<?php echo $display; ?>>
