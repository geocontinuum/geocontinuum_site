...
ob_start();
?>
    <div class="dragifywp-dnd__emptyItem dragifywp-dnd__emptyItem--v" style="height:60px;" ng-if="!$ctrl.edited.content.length">
...
function lhb_v_social_icons_callback($attrs, $content = null) {
    ...
    ob_start(); ?>
    <div class="dragifywp-socialIcons <?php echo implode(' ', $classes); ?>"<?php echo $id; ?>>
