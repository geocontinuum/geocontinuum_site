        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        "@id .dragifywp-box__overlay" => array(
...
ob_start();
?>
<div class="dragifywp-box__wrap">
    <div class="dragifywp-box {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]" id="{{$ctrl.edited.attrs.id}}">
        <div class="dragifywp-box__overlay"></div>
...
add_shortcode('dragifywp_box', 'dragifywp_box_callback');
function dragifywp_box_callback($attrs, $content = null) {
    ...
    ob_start(); ?>
    <div class="dragifywp-box__wrap">
        <div class="dragifywp-box <?php echo implode(' ', $classes); ?>"<?php echo $id.$animation.$parallax; ?>>
