...
<div class="dragifywp-dnd__emptyItem" style="height:100px;" ng-if="!$ctrl.edited.attrs.image.url">
    <span class="dragifywp-dnd__emptyItem__label">Image</span>
</div>

<div class="dragifywp-image__container {{::$ctrl.getID()}}" ng-class="$ctrl.edited.attrs.float_right">
    <img class="dragifywp-image" id="{{$ctrl.edited.attrs.id}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]"
...
add_shortcode('dragifywp_image', 'dragifywp_image_callback');
function dragifywp_image_callback($attrs) {
    ...
    ob_start(); ?>
    <div class="dragifywp-image__container <?php echo implode(' ', $classes) ?>">
        <?php echo $link_before; ?>
        <img class="dragifywp-image"<?php echo $id; ?> src="<?php echo $attrs['image']['url'] ?>"<?php echo $animation . $alt . $srcset . $sizes; ?>/>
        <?php echo $link_after; ?>
    </div>
    <?php
    return ob_get_clean();
