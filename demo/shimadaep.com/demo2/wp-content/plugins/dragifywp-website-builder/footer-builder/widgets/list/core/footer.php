                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "styles" => array(
                                ".dragifywp-site__footer__prev" => array(
                ...
                array(
                    ...
                    "content" => [
                        array(
                            ...
                            "styles" => array(
                                "@id .dragifywp-footer__overlay" => array(
...
ob_start();
?>
<div class="dragifywp-footer {{::$ctrl.getID()}}"
     dragifywp-footer-parallax model="$ctrl.edited.attrs.parallax"
     ng-class="[{'dragifywp-footer--parallax': $ctrl.edited.attrs.parallax && !$ctrl.edited.attrs.fixed},$ctrl.edited.attrs.fixed,'dragifywp-footer--bgStyle-' + $ctrl.edited.attrs.bg_style, $ctrl.edited.attrs.class]" id="{{$ctrl.section.attrs.id}}">
    <div class="dragifywp-footer__overlay" ng-show="$ctrl.edited.attrs.overlay"></div>
    <div class="dragifywp-footer__container">
        <dragifywp-section-list></dragifywp-section-list>
    </div>
</div>
<?php
...
function lfb_footer_callback($attrs, $content = '') {
    ...
    if (dragifywp_to_boolean($attrs['parallax']) && !$attrs['fixed']) {
        $classes[] = 'dragifywp-footer--parallax';
    }
    ...
    $classes[] = 'dragifywp-footer--bgStyle-' . $attrs['bg_style'];
    $id = $attrs['id'] ? ' id="' . $attrs['id'] . '"' : '';

    $classes[] = $attrs['class_id'];

    ob_start(); ?>
    <div class="dragifywp-footer <?php echo implode(' ', $classes); ?>"<?php echo $id; ?>>
        <?php if (dragifywp_to_boolean($attrs['overlay'])) : ?>
            <div class="dragifywp-footer__overlay"></div>
        <?php endif; ?>
        <div class="dragifywp-footer__container">
