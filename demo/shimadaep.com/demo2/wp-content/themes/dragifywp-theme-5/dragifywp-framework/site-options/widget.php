    ...
    "models" => [
        array(
            ...
            "content" => [
                ...
                array(
                    "tag" => "editor-field",
                    "bind_to" => "dragifywp_fw_widget_cat_a_color",
                    "attrs" => array(
                        "label" => "Cat Link",
                        "type" => "colorpicker"
                    ),
                    ...
                    "styles" => array(
                        ".dragifywp-widget:not(.widget_dragifywp_fw_block_widget) a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    "tag" => "editor-field",
                    "bind_to" => "dragifywp_fw_widget_title_a_color",
                    "attrs" => array(
                        "label" => "Title Link",
                        "type" => "colorpicker"
                    ),
                    ...
                    "styles" => array(
                        ".dragifywp-widget:not(.widget_dragifywp_fw_block_widget) .dragifywp-widget__media__link" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    "tag" => "editor-field",
                    "bind_to" => "dragifywp_fw_widget_a_hover",
                    "attrs" => array(
                        "label" => "Link Hover",
                        "type" => "colorpicker"
                    ),
                    ...
                    "styles" => array(
                        ".dragifywp-widget:not(.widget_dragifywp_fw_block_widget) a:hover,.dragifywp-widget__twitter__content a" => array(
                            "color" => "{{@model}}"
                        )
                    )
                )
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-page--sidebarRight .dragifywp-widget,.dragifywp-page--sidebarRightRight .dragifywp-widget,.dragifywp-page--sidebarLeftRight .dragifywp-page__sidebar--second .dragifywp-widget" => array(
                            "padding" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-page--sidebarLeft .dragifywp-widget,.dragifywp-page--sidebarLeftLeft .dragifywp-widget,.dragifywp-page--sidebarLeftRight .dragifywp-page__sidebar--first .dragifywp-widget" => array(
                            "padding" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-widget__title:after" => array(
                            "borderColor" => "{{@model}}"
                        )
                    )
                )
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-widget .tagcloud a" => array(
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-widget .tagcloud a:hover" => array(
                            "backgroundColor" => "{{@model}}"
                        )
                    )
                ),
...
$manager::addChildPanel("widget_media_stream", "widgets", array(
    "name" => "Photo Stream",
    "direct_links" => array(
        ".dragifywp-widget__mediaStream" => array(
            "position" => array(
                "top" => "0px",
                "left" => "0px"
            )
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "responsive_styles" => array(
                        ".dragifywp-widget__mediaStream__item" => array(
