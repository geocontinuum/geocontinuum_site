...
$manager::addChildPanel("load_more_button", "loader", array(
    ...
    "direct_links" => array(
        ".dragifywp-loadMoreBtn__wrap" => array(
            "position" => array(
                "left" => "20px",
                "top" => "3px"
            ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-loadMoreBtn--loading,.dragifywp-loadMoreBtn:hover" => array(
                            "color" => "{{@model}}"
                        ),
                        ".dragifywp-loadMoreBtn__icon" => array(
                            "borderColor" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-infinitePreloader__icon" => array(
                            "borderColor" => "{{@model}}"
                        )
                    )
                )
        ...
        array(
            ...
            "content" => [
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-infinitePreloader__text" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-contentLoader span:after,.dragifywp-lazyImage:before,.dragifywp-mediaLoader:before" => array(
                            "backgroundColor" => "{{@model}}"
                        )
                    )
                )
                        ...
                        array(
                            ...
                            "content" => [
                                array(
                                    ...
                                    "styles" => array(
                                        ".dragifywp-sitePreloader__icon--img" => array(
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => $manager::$colors["body"],
                    "styles" => array(
                        ".dragifywp-blogPagination__btn" => array(
                            "backgroundColor" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "default_value" => $manager::$colors["primary"],
                    "styles" => array(
                        ".dragifywp-blogPagination__btn, .dragifywp-blogPagination__prev, .dragifywp-blogPagination__next" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "default_value" => $manager::$colors["primary"],
                    "styles" => array(
                        ".dragifywp-blogPagination a:hover" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
                ...
                array(
                    ...
                    "default_value" => $manager::$colors["border"],
                    "styles" => array(
                        ".dragifywp-blogPagination__link--current" => array(
                            "borderColor" => "{{@model}}"
                        )
                    )
                ),
                array(
                    ...
                    "styles" => array(
                        ".dragifywp-blogPagination,.dragifywp-blogPagination__link--disabled,.dragifywp-blogPagination__link--current" => array(
                            "color" => "{{@model}}"
                        )
                    )
                ),
