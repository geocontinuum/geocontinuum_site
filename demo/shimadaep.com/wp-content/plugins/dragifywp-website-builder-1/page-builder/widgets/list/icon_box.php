        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 18,
                    "styles" => array(
                        "@id .dragifywp-iconBox__icon" => array(
                            "fontSize" => "{{@model}}px"
                        )
                    )
                ),
                array(
                    ...
                    "default_value" => 40,
                    "styles" => array(
                        "@id .dragifywp-iconBox__icon__holder" => array(
                            "width" => "{{@model}}px",
                            "height" => "{{@model}}px"
                        ),
                        "@id .dragifywp-iconBox__icon" => array(
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 13,
                    "styles" => array(
                        "@id .dragifywp-iconBox__title" => array(
                            "fontSize" => "{{@model}}px"
                        )
                    )
                ),
        ...
        array(
            ...
            "content" => [
                ...
                array(
                    ...
                    "default_value" => 14,
                    "styles" => array(
                        "@id .dragifywp-iconBox__desc" => array(
                            "fontSize" => "{{@model}}px"
                        )
                    )
                ),
...
ob_start();
?>
<div class="dragifywp-iconBox {{::$ctrl.getID()}}" id="{{$ctrl.edited.attrs.id}}" ng-class="[$ctrl.service.formResClass($ctrl.edited.attrs.icon_position, 'dragifywp-iconBox'),$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]">
    <div class="dragifywp-iconBox__icon">
        <div class="dragifywp-iconBox__icon__holder" dragifywp-animate="$ctrl.edited.attrs.animation">
            <i ng-class="$ctrl.edited.attrs.icon.source + ' ' + $ctrl.edited.attrs.icon.source + '-' + $ctrl.edited.attrs.icon.icon"></i>
        </div>
    </div>
    <div class="dragifywp-iconBox__content">
        <h5 class="dragifywp-iconBox__title" dragifywp-editable model="$ctrl.edited" config="{target:'attrs.heading', editorType:'1'}" ng-bind-html="$ctrl.edited.attrs.heading"></h5>
        <p class="dragifywp-iconBox__desc" dragifywp-editable model="$ctrl.edited" config="{target:'content', editorType:'1'}" ng-bind-html="$ctrl.edited.content"></p>
    </div>
</div>
<?php
...
add_shortcode('dragifywp_icon_box', 'dragifywp_icon_box_callback');
function dragifywp_icon_box_callback($attrs, $content = null) {
    ...
    $icon_position = dragifywp_form_res_class($attrs['icon_position'], 'dragifywp-iconBox');
    if($icon_position){
    ...
    ob_start(); ?>
    <div class="dragifywp-iconBox <?php echo implode(' ', $classes); ?>"<?php echo $id; ?>>
        <div class="dragifywp-iconBox__icon">
            <div class="dragifywp-iconBox__icon__holder"<?php echo $animation; ?>>
                <i class="<?php echo $icon_class; ?>"></i>
            </div>
        </div>
        <div class="dragifywp-iconBox__content">
            <h5 class="dragifywp-iconBox__title"><?php echo html_entity_decode($attrs['heading']); ?></h5>
            <p class="dragifywp-iconBox__desc"><?php echo do_shortcode($content); ?></p>
        </div>
    </div>
    <?php
    return ob_get_clean();
