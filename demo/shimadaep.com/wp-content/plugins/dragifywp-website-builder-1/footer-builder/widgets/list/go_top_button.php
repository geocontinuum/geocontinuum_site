...
ob_start();
?>
<div class="dragifywp-goTop {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]">
    <button class="dragifywp-goTop__btn" data-delay="{{$ctrl.edited.attrs.delay}}" bind-go-top-button>
...
function lfb_go_top_button_callback($attrs) {
    ...
    ob_start(); ?>
    <div class="dragifywp-goTop <?php echo implode(' ', $classes); ?>">
        <button class="dragifywp-goTop__btn" data-delay="<?php echo $attrs['delay']; ?>" href="#<?php echo $attrs['section_id']; ?>"><i class="<?php echo $attrs['icon']; ?>"></i></button>
    </div>
    <?php
    return ob_get_clean();
}