...
ob_start();
?>
<div class="dragifywp-dnd__emptyItem dragifywp-dnd__emptyItem--v" style="height:80px;" ng-if="!$ctrl.edited.content">
    <span class="dragifywp-dnd__emptyItem__label">Heading</span>
</div>

<h4 class="dragifywp-aside__heading {{::$ctrl.getID()}}" ng-class="[$ctrl.edited.attrs.class, $ctrl.edited.attrs.hidden]" ng-bind-html="$ctrl.edited.content | trustashtml"></h4>
<?php
...
function lhb_v_heading_callback($attrs, $content = null) {
    ...
    $html = '<h4 class="dragifywp-aside__heading '.implode(' ', $classes).'">'.$content.'</h4>';
